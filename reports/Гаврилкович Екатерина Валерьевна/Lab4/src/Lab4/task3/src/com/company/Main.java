...
//create books
        Book[] books = { new Book(bookNames[0], "Bulgakov", 3),
                new Book(bookNames[1], "Gogol", 5),
                new Book(bookNames[2], "Tolstoy", 1) };
//create readers
        Reader[] readers = { new Reader("Ivan Ivanov", "24.05.2019"),
                new Reader("Ivan Petrov", "04.12.2019"),
                new Reader("Ivan Sergeev", "01.12.2019") ,
                new Reader("Ivan Semenov", "05.12.2019")};
